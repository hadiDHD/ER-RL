...
public class ExpTrainerStagedA3C {
    ...
    static int epochStep = ExpState.MAX_ELEMENTS / 2;
...
//            ACPolicy<ExpState> policy = null;
            String loadName = "1649933045502";
            ACPolicy<ExpState> policy = ACPolicy.load(
                    "C:\\Users\\hadid\\IdeaProjects\\er\\neural networks\\gen\\a3c\\" + loadName + "_value",
                    "C:\\Users\\hadid\\IdeaProjects\\er\\neural networks\\gen\\a3c\\" + loadName + "_policy"
            );
            ...
            for (int i = 0; i < 10; i++) {
                ...
                double reward = play(dql.getPolicy(), new ExpMDP(model), validActionRange);

                if (true) {
                    try {
                        String name = System.currentTimeMillis() + "";
                        File valueN = new File("neural networks/gen/a3c/" + name + "_value");
                        File policyN = new File("neural networks/gen/a3c/" + name + "_policy");
