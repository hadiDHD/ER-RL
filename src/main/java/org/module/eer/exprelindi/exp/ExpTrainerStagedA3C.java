...
//                    "C:\\Users\\hadid\\IdeaProjects\\er\\neural networks\\indi\\a3c\\" + loadName + "_value",
//                    "C:\\Users\\hadid\\IdeaProjects\\er\\neural networks\\indi\\a3c\\" + loadName + "_policy"
//            );
            ...
            for (int i = 0; i < 100; i++) {
                ...
                if (i % 10 == 9) {
                    try {
                        ...
                        File valueN = new File("neural networks/indi/a3c/" + name + "_value");
                        File policyN = new File("neural networks/indi/a3c/" + name + "_policy");
